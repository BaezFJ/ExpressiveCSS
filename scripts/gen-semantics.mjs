...
export function render(data) {
  ...
  l.push('CONTEXT.md defines all three. Their rules run the same either way: a kind says what a row is,');
  ...
  const indebted = names.filter((n) => data.rows[n].conformance);
