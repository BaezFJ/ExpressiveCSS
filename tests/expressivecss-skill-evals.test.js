...
describe('ExpressiveCSS behavioral evaluation runner', () => {
  ...
  test('owns stable critical invariants and covers every routing boundary', () => {
    ...
    const exactRoutes = {
      ...
      'feedback-component-choice': ['expressivecss-design', 'expressivecss-usage', 'expressivecss-runtime', 'expressivecss-accessibility', 'component:snackbar', 'component:dialogs'],
      'feedback-inline-choice': ['expressivecss-design', 'expressivecss-usage', 'expressivecss-accessibility', 'component:snackbar', 'component:dialogs'],
      'feedback-dialog-choice': ['expressivecss-design', 'expressivecss-usage', 'expressivecss-accessibility', 'component:snackbar', 'component:dialogs'],
