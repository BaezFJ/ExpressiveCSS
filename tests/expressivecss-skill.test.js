...
describe('the ExpressiveCSS agent skill', () => {
  ...
  test('lets the generated decision index own every component guide exactly once', () => {
    ...
    assert.equal(componentFiles.length, 42);
  ...
  test('keeps generated component guides synchronized with their sources', () => {
    ...
    assert.match(result.stdout, /42 ExpressiveCSS component guides are current\./);
    ...
    assert.match(mcpResult.stdout, /Verified 42 bundled guides and normative semantics\./);
  });
