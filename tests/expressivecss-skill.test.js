...
describe('the ExpressiveCSS agent skill', () => {
  ...
  test('lets the generated decision index own every component guide exactly once', () => {
    ...
    assert.equal(componentFiles.length, 43);
  ...
  test('keeps generated component guides synchronized with their sources', () => {
    ...
    assert.match(result.stdout, /43 ExpressiveCSS component guides are current\./);
    ...
    assert.match(mcpResult.stdout, /Verified 43 bundled guides and normative semantics\./);
  });
