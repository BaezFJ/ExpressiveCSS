...
export const AUTO_INIT_FIXTURES = [
  ...
  },
  {
    ...
    html: `<article class="expanding-card"><button type="button" class="expanding-card-trigger">Open</button><dialog id="expanded-card" class="expanding-card-dialog" aria-label="Expanded card"><button type="button" class="expanding-card-close">Close</button></dialog></article>`,
  },
  {
    name: "Carousel",
    selector: ".carousel",
