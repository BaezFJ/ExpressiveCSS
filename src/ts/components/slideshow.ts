...
export interface SlideshowOptions extends BaseOptions {
  /**
...
const _defaults: SlideshowOptions = {
  indicators: true,
  height: 400,
  duration: 500,
  interval: 6000,
...
export class Slideshow extends Component<SlideshowOptions> {
  ...
  constructor(el: HTMLElement, options: Partial<SlideshowOptions>) {
    super(el, options, Slideshow);
    this.el['Expressive_Slideshow'] = this;
  ...
  /**
   * Initializes instance of Slideshow.
   * @param el HTML element.
   * @param options Component options.
   */
  static init(el: HTMLElement, options?: Partial<SlideshowOptions>): Slideshow;
  /**
   * Initializes instances of Slideshow.
   * @param els HTML elements.
   * @param options Component options.
   */
  static init(els: InitElements<InitElement>, options?: Partial<SlideshowOptions>): Slideshow[];
  /**
   * Initializes instances of Slideshow.
   * @param els HTML elements.
   * @param options Component options.
  ...
  static init(
    ...
    options: Partial<SlideshowOptions> = {}
  ): Slideshow | Slideshow[] {
    return super.init(els, options, Slideshow);
  }

  static getInstance(el: HTMLElement): Slideshow {
    return el['Expressive_Slideshow'];
  }
  ...
  destroy() {
    ...
    this.el['Expressive_Slideshow'] = undefined;
  }
